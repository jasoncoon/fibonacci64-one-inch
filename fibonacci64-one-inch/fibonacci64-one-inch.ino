/*
   One Inch Fibonacci64 Touch Demo: https://github.com/jasoncoon/fibonacci64-one-inch
...
uint16_t touchMin[touchPointCount] = { 192, 225, 271 };
...
uint8_t touchPointX[touchPointCount] = { 0, 168, 255 };
uint8_t touchPointY[touchPointCount] = { 164, 255, 80 };
